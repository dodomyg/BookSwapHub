...
import { Card, CardBody, Heading, Text, Stack, Image, Button, CardFooter, HStack, Flex } from '@chakra-ui/react'
...
if(!user) return;
  return (
    <div>
        ...
        {!loading && returned.length===0 ? <h1 style={{width:"850px",textAlign:"center"}}>You are not holding any books right now</h1> : !loading && returned.map((book)=>(
          <Card
          key={book?._id}
